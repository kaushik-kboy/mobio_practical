                        ...
                        <table class="table">
                            ...
                            { ?>
                                <tr>
                                    ...
                                    <td>
                                      <ul>
                                        <li><?php echo $row["state"];?>
                                          <ul>
                                            <li><?php echo $row["city"];?></td></li>
                                          </ul>
                                        </li>
                                      </ul>
                                    <td>
                                        <a href="user_data.php?u_id=<?php echo $row["id"];?>"><i class="icon-trash-o"></i></a>
                                        <a href="edit_user.php?u_id=<?php echo $row["id"];?>"><i class="icon-edit2"></i></a>
                                    </td>
                                </tr>
                            <?php }
                            ?>
